...
func (os *OrganizationSeeder) Seed(db *gorm.DB) error {
	...
	mainOrganizations := []*models.Organization{
		...
		},
		{
			...
			Email:       "info@secureit-valencia.es",
			Website:     "https://secureit-valencia.es",
			...
			Status:      models.OrgStatusActive,
			IsVerified:  true,
			LinkedIn:    "https://linkedin.com/company/secureit-valencia",
			TaxID:       "A11223344",
			LegalName:   "SecureIT Valencia S.A.",
		},
		{
